...
async function getAllSurveysInfo()
{ // call: GET /api/surveysInfo
...
async function getAllSurveysQuestions()
{ // call: GET /api/surveysQuestions
...
async function getAllSurveysAnswers()
{ // call: GET /api/surveysAnswers
...
async function addFilledSurvey(filledSurvey)
{// call: GET api/filledSurvey
...
async function addNewSurvey(title, owner, date, questions)
{// call: GET /api/survey
    return new Promise((resolve, reject) => {
        fetch( '/api/survey', {
          method: 'POST',
...
const API = { getAllSurveysInfo, getAllSurveysQuestions, getAllSurveysAnswers, addFilledSurvey, addNewSurvey};
export default API
